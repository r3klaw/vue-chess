<template>
    <div>
        ...
        <md-navbar title="Chess" hamburger mode="hide-on-med-and-down" left nav-class="blue darken-4">
        ...
        <div>
            <md-modal id="aboutModal">
                ...
                <md-card>
                    ...
                    <p>
                        <a href="https://r3klaw.github.io">{{ $t("about.seemore") }}</a>
                    </p>
                    <div slot="reveal">
                      <span class="card-title grey-text text-darken-4">
                        ...
                        <p>
                            David Rashid rashid.david12@gmail.com 2020
                        </p>
