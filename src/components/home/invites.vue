...
export default {
  ...
  methods: {
    ...
    InviteGameAction (invite) {
      ...
      if (invite.confirm || invite.vsPc) {
        ...
        this.toast('<span>waiting for confirmation from your oponent</span>', 2000)
      }
    ...
    deleteInvite (invite) {
      ...
      if (post !== -1) {
        ...
        this.toast('<span>Cancelled game invitation</span>', 2000)
      }
    },
    pcGameInit () {
  ...
  events: {
    inviteGame (data) {
      ...
      Store.set('invitesGame', this.invitesGame)
      this.toast('<span>You have been invited for a chess game</span>', 5000)
    },
    confirmGame (data) {
      ...
      this.toast('<span>Invitation confirmed</span>', 5000)
    },
    initGame (data) {
